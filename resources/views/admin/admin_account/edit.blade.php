...
@section('content_admin')
    ...
    @if(!empty($admin_info->images))
        @php
           $image_default = url($admin_info->images);
        @endphp
    @else
        @php
                    ...
                    <div class="widgetcontent nopadding">
                        ...
                        <form class="stdform stdform2" method="post" action="" enctype="multipart/form-data">
                            ...
                            <p>
                               ...
                               placeholder="Nhập tên" name="name" value="{!! old('name', isset($admin_info) ? $admin_info->name : null) !!}">
                                </span>
                            </p>
                            ...
                            <p>
                                ...
                                <span class="field">
                                    <input type="email" class="form-control input-xxlarge" id="exampleInputEmail1" placeholder="Nhập email" name="email" value="{!! old('email', isset($admin_info) ? $admin_info->email : null) !!}">
                                </span>
                            </p>
                            <p>
                                ...
                                <span class="field">
                                    <select name="role" id="" class="form-control">
                                        @foreach($role as $k => $v)
                                            <option value="{{$k}}" {{ $admin_info->role == $k ? 'selected=""' : '' }}>{{$v}}</option>
                                        @endforeach
                                    </select>
                                </span>
                            </p>
                            ...
                            <p>
                                ...
                                <span class="field">
                                   <input type="password" class="form-control input-xxlarge" name="password" value="">
                                </span>
                            </p>
