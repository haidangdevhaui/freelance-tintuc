                    ...
                    <div class="widgetcontent nopadding">
                        <form class="stdform stdform2" method="post" action="" enctype="multipart/form-data">
                            ...
                            <p>
                               ...
                               placeholder="Nhập tiêu đề video" name="title" value="{{ isset($video) ? (old('title') ? old('title') : $video->title) : '' }}">
                            ...
                            <p>
                               ...
                               name="slug" value="{{ isset($video) ? (old('slug') ? old('slug') : $video->slug) : '' }}">
                            ...
                            <p>
                               ...
                               name="source" value="{{ isset($video) ? (old('source') ? old('source') : $video->source) : '' }}">
                            ...
                            <p>
                                ...
                                <span class="field">
                                    <textarea class="textarea_fix_width_form" name="description" id="" cols="30" rows="10">{{ isset($video) ? (old('description') ? old('description') : $video->description) : '' }}</textarea>
                            ...
                            <p>
                                ...
                                <span class="field">
                                    <textarea class="textarea_fix_width_form" name="content" id="">{{ isset($video) ? (old('content') ? old('content') : $video->content) : '' }}</textarea>
                            ...
                            <p>
                               ...
                               name="meta_title" value="{{ isset($video) ? (old('meta_title') ? old('meta_title') : $video->meta_title) : '' }}">
                            ...
                            <p>
                               ...
                               name="meta_keyword" value="{{ isset($video) ? (old('meta_keyword') ? old('meta_keyword') : $video->meta_keyword) : '' }}">
                            ...
                            <p>
                                ...
                                <span class="field">
                                    <textarea class="textarea_fix_width_form" name="meta_description" id="" cols="30" rows="10">{{ isset($video) ? (old('meta_description') ? old('meta_description') : $video->meta_description) : '' }}</textarea>
                            ...
                            <p class="stdformbutton">
                                <button class="btn btn-primary">{{ isset($video) ? 'Cap nhat' : 'Thêm' }} </button>
                            </p>
                        </form>
                    </div><!--widgetcontent-->
                </div><!--widget-->
