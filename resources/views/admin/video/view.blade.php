                            ...
                            <div class="widgetcontent nopadding">
                                ...
                                <form class="stdform stdform2">
                                    ...
                                    <p>
                                        ...
                                        <span class="field">
                                            <input disabled type="text" class="form-control name_add_cat input-xxlarge" id="exampleInputEmail1"
                                    ...
                                    <p>
                                        ...
                                        <span class="field">
                                            <input disabled type="slug" class="form-control add_slug_cat input-xxlarge" id="exampleInputPassword1" placeholder="Nhập slug"
                                    ...
                                    <p>
                                        ...
                                        <span class="field">
                                            <input disabled type="url" class="form-control input-xxlarge" id="exampleInputPassword1" placeholder="Nhập url"
                                    ...
                                    <p>
                                        ...
                                        <span class="field">
                                            <textarea disabled class="textarea_fix_width_form" name="description" id="" cols="30" rows="10">{!! old('description', $video_collect_val->description) !!}</textarea>
                                        </span>
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <span class="field">
                                            <textarea disabled name="content" id="">{!! old('content', $video_collect_val->content) !!}</textarea>
                                            <script>
                                                jQuery(function($) {
                                                    ckeditor('content');
                                                })
                                    ...
                                    <p>
                                        ...
                                        <span class="field">
                                            <textarea disabled class="textarea_fix_width_form" name="meta_description" id="" cols="30" rows="10">{!! old('meta_description', $video_collect_val->meta_description) !!}</textarea>
                                        </span>
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <span class="field">
                                            <input disabled  type="text" data-role="tagsinput" id="tag_news" name="tag_news" class="form-control" placeholder="Điền tên thẻ" value="{!! old('tag_news', $video_collect_val->tags) !!}">
                                        </span>
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        <span class="field">
                                            <input disabled class="js-switch" type="checkbox" @if($video_collect_val->status == 1) {{ "checked" }} @endif name="checkbox">
                                        </span>
                                    </p>
                                </form>
                            </div><!--widgetcontent-->
