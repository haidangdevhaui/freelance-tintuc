                    ...
                    <div class="widgetcontent nopadding">
                        ...
                        <form class="stdform stdform2">
                            ...
                            <p>
                                ...
                                <span class="field">
                                    <input disabled type="email" class="form-control input-xxlarge" id="exampleInputEmail1"
                            ...
                            <div class="form-group category_parent_add_news">
                                ...
                                <span class="field">
                                    <select disabled name="role_user">
                            ...
                            <p>
                                ...
                                <span class="field">
                                    <input disabled class="js-switch" @if($admin_info->status == 1) {{ 'checked' }} @endif type="checkbox" name="checkbox"> Kích hoạt
                                </span>
                            </p>
