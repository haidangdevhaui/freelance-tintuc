        ...
        <div class="maincontentinner">
            <div class="widgetbox box-inverse">
                ...
                <div class="widgetcontent nopadding">
                    ...
                    @endif
                    <form action="{{ isset($post) ? route('post_edit', $post->id) : route('post_create') }}" class="stdform stdform2" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
                        <p>
