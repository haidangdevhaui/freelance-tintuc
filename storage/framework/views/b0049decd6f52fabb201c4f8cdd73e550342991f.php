    ...
    <div class="leftmenu">
        <ul class="nav nav-tabs nav-stacked">
            ...
            <li class="dropdown"><a href=""><span class="iconfa-th-list"></span> Quản lý tin tức</a>
                <ul>
                    <li><a href="<?php echo e(URL::route('post_index')); ?>">Danh sách tin tức </a></li>
            ...
            <li class="dropdown"><a href=""><span class="iconfa-th-list"></span> Quản lý Video</a>
                <ul>
                    <li><a href="<?php echo e(URL::route('video_index')); ?>">Danh sách Video </a></li>
                    <li><a href="<?php echo e(URL::route('video_create')); ?>">Thêm Video </a></li>
                </ul>
            </li>
        </ul>
    </div>
